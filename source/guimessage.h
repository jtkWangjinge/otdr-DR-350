...
#define GUIMESSAGE_THD_CREATE       2   //系统消息，建立窗体线程
#define GUIMESSAGE_THD_DESTROY      3   //系统消息，销毁窗体线程
...
#define GUIMESSAGE_LOP_DISABLE      11  //窗体消息，禁止并停止窗体循环
#define GUIMESSAGE_ERR_PROC         12  //窗体消息，执行错误处理
#define GUIMESSAGE_KNB_CLOCK        13  //窗体消息，旋钮顺时针旋转
#define GUIMESSAGE_KNB_ANTI         14  //窗体消息，旋钮逆时针旋转
#define GUIMESSAGE_KEY_DOWN         15  //窗体消息，按键按下
#define GUIMESSAGE_KEY_UP           16  //窗体消息，按键松开
#define GUIMESSAGE_TCH_DOWN         17  //窗体消息，点击触摸屏
#define GUIMESSAGE_TCH_UP           18  //窗体消息，离开触摸屏
#define GUIMESSAGE_MOV_FOCUS        19  //窗体消息，移动按键焦点
#define GUIMESSAGE_MOV_CURSOR       20  //窗体消息，移动触屏光标
#define GUIMESSAGE_MT		        21  //窗体消息，多点触摸
#define GUIMESSAGE_KEY_PRESS        22  //窗体消息，长按按键
#define GUIMESSAGE_KEY_CANCEL_PRESS 23  //窗体消息，取消长按按键
