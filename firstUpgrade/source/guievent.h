...
* 定义GUI中事件代码
******************/
#define GUIEVENT_KEY_DOWN       1   //事件，按键按下
#define GUIEVENT_KEY_UP         2   //事件，按键松开
#define GUIEVENT_ABS_DOWN       3   //事件，点击触摸屏
#define GUIEVENT_ABS_UP         4   //事件，离开触摸屏
#define GUIEVENT_KNB_CLOCK      5   //事件，旋钮顺时针旋转
#define GUIEVENT_KNB_ANTI       6   //事件，旋钮逆时针旋转
...
typedef struct _event_item
{
    ...
    unsigned int uiEventValue;  //事件数值，按键编码或坐标数值
} GUIEVENT_ITEM;
